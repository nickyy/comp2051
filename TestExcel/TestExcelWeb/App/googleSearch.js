...
function searchGoogle(firstName, lastName, city) {
    ...
    // First name and last name are both present, so fetch the JSON results
        ...
        var query = firstName + "%20" + lastName + "%20" + city;
...
function searchComplete(results){
    ...
    for (var i=0; i<results.items.length; i++){
        ...
        outputHtml += '<li><input type="checkbox" class="checkbox" value="goog' + i + '"><span style="font-weight:bold"><a href="'+ link + '" id="goog' + i + '">' + title + '</a></span><p>' + snippet + '</p></li>';
